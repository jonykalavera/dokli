...
class MariadbSaveExternalPortRequest(BaseModel):
    """MariadbSaveExternalPortRequest
    """  # noqa: E501

    mariadb_id: StrictStr = Field(alias="mariadbId")
    external_port: StrictFloat | StrictInt | None = Field(alias="externalPort")
    __properties: ClassVar[list[str]] = ["mariadbId", "externalPort"]
    ...
    def from_dict(cls, obj: dict[str, Any] | None) -> Self | None:
        ...
        _obj = cls.model_validate({"mariadbId": obj.get("mariadbId"), "externalPort": obj.get("externalPort")})
        return _obj
