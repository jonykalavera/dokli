...
class NotificationTestSlackConnectionRequest(BaseModel):
    ...
    def from_dict(cls, obj: dict[str, Any] | None) -> Self | None:
        ...
        _obj = cls.model_validate({"webhookUrl": obj.get("webhookUrl"), "channel": obj.get("channel")})
        return _obj
