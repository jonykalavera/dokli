...
class ComposeDeployTemplateRequest(BaseModel):
    """ComposeDeployTemplateRequest
    """  # noqa: E501

    project_id: StrictStr = Field(alias="projectId")
    id: Annotated[str, Field(min_length=1, strict=True)]
    __properties: ClassVar[list[str]] = ["projectId", "id"]
    ...
    def from_dict(cls, obj: dict[str, Any] | None) -> Self | None:
        ...
        _obj = cls.model_validate({"projectId": obj.get("projectId"), "id": obj.get("id")})
        return _obj
