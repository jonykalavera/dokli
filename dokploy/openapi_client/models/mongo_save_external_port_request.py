...
class MongoSaveExternalPortRequest(BaseModel):
    ...
    __properties: ClassVar[list[str]] = ["mongoId", "externalPort"]
    ...
    def from_dict(cls, obj: dict[str, Any] | None) -> Self | None:
        ...
        _obj = cls.model_validate({"mongoId": obj.get("mongoId"), "externalPort": obj.get("externalPort")})
        return _obj
