...
class RegistryCreateRequest(BaseModel):
    ...
    registry_name: Annotated[str, Field(min_length=1, strict=True)] = Field(alias="registryName")
    ...
    registry_type: StrictStr = Field(alias="registryType")
    image_prefix: StrictStr | None = Field(alias="imagePrefix")
