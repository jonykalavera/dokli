...
class SshKeyUpdateRequest(BaseModel):
    ...
    last_used_at: StrictStr | None = Field(default=None, alias="lastUsedAt")
    ssh_key_id: StrictStr = Field(alias="sshKeyId")
    __properties: ClassVar[list[str]] = ["name", "description", "lastUsedAt", "sshKeyId"]
