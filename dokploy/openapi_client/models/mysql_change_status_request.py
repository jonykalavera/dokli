...
class MysqlChangeStatusRequest(BaseModel):
    """MysqlChangeStatusRequest
    """  # noqa: E501

    mysql_id: StrictStr = Field(alias="mysqlId")
    application_status: StrictStr = Field(alias="applicationStatus")
    __properties: ClassVar[list[str]] = ["mysqlId", "applicationStatus"]
    ...
    def from_dict(cls, obj: dict[str, Any] | None) -> Self | None:
        ...
        _obj = cls.model_validate({"mysqlId": obj.get("mysqlId"), "applicationStatus": obj.get("applicationStatus")})
        return _obj
