...
class RedisChangeStatusRequest(BaseModel):
    ...
    def from_dict(cls, obj: dict[str, Any] | None) -> Self | None:
        ...
        _obj = cls.model_validate({"redisId": obj.get("redisId"), "applicationStatus": obj.get("applicationStatus")})
        return _obj
