...
class MariadbChangeStatusRequest(BaseModel):
    ...
    __properties: ClassVar[list[str]] = ["mariadbId", "applicationStatus"]
    ...
    def from_dict(cls, obj: dict[str, Any] | None) -> Self | None:
        ...
        _obj = cls.model_validate(
            {"mariadbId": obj.get("mariadbId"), "applicationStatus": obj.get("applicationStatus")}
        )
        return _obj
