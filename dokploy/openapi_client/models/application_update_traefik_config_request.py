...
class ApplicationUpdateTraefikConfigRequest(BaseModel):
    """ApplicationUpdateTraefikConfigRequest
    """  # noqa: E501

    application_id: StrictStr = Field(alias="applicationId")
    traefik_config: StrictStr = Field(alias="traefikConfig")
    __properties: ClassVar[list[str]] = ["applicationId", "traefikConfig"]
    ...
    def from_dict(cls, obj: dict[str, Any] | None) -> Self | None:
        ...
        _obj = cls.model_validate(
            {"applicationId": obj.get("applicationId"), "traefikConfig": obj.get("traefikConfig")}
        )
        return _obj
