...
class PostgresChangeStatusRequest(BaseModel):
    ...
    __properties: ClassVar[list[str]] = ["postgresId", "applicationStatus"]
    ...
    def from_dict(cls, obj: dict[str, Any] | None) -> Self | None:
        ...
        _obj = cls.model_validate(
            {"postgresId": obj.get("postgresId"), "applicationStatus": obj.get("applicationStatus")}
        )
        return _obj
