...
class RegistryEnableSelfHostedRegistryRequest(BaseModel):
    """RegistryEnableSelfHostedRegistryRequest
    """  # noqa: E501

    registry_url: Annotated[str, Field(min_length=1, strict=True)] = Field(alias="registryUrl")
    username: Annotated[str, Field(min_length=1, strict=True)]
    password: Annotated[str, Field(min_length=1, strict=True)]
    __properties: ClassVar[list[str]] = ["registryUrl", "username", "password"]
    ...
    def from_dict(cls, obj: dict[str, Any] | None) -> Self | None:
        ...
        _obj = cls.model_validate(
            {"registryUrl": obj.get("registryUrl"), "username": obj.get("username"), "password": obj.get("password")}
        )
        return _obj
