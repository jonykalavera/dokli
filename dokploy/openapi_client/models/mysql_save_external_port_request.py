...
class MysqlSaveExternalPortRequest(BaseModel):
    ...
    __properties: ClassVar[list[str]] = ["mysqlId", "externalPort"]
    ...
    def from_dict(cls, obj: dict[str, Any] | None) -> Self | None:
        ...
        _obj = cls.model_validate({"mysqlId": obj.get("mysqlId"), "externalPort": obj.get("externalPort")})
        return _obj
