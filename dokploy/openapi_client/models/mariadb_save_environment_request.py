...
class MariadbSaveEnvironmentRequest(BaseModel):
    ...
    def from_dict(cls, obj: dict[str, Any] | None) -> Self | None:
        ...
        _obj = cls.model_validate({"mariadbId": obj.get("mariadbId"), "env": obj.get("env")})
        return _obj
