...
class RedisSaveExternalPortRequest(BaseModel):
    ...
    __properties: ClassVar[list[str]] = ["redisId", "externalPort"]
    ...
    def from_dict(cls, obj: dict[str, Any] | None) -> Self | None:
        ...
        _obj = cls.model_validate({"redisId": obj.get("redisId"), "externalPort": obj.get("externalPort")})
        return _obj
