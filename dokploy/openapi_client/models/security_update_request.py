...
class SecurityUpdateRequest(BaseModel):
    ...
    security_id: Annotated[str, Field(min_length=1, strict=True)] = Field(alias="securityId")
    username: Annotated[str, Field(min_length=1, strict=True)]
    password: Annotated[str, Field(min_length=1, strict=True)]
    __properties: ClassVar[list[str]] = ["securityId", "username", "password"]
    ...
    def from_dict(cls, obj: dict[str, Any] | None) -> Self | None:
        ...
        _obj = cls.model_validate(
            {"securityId": obj.get("securityId"), "username": obj.get("username"), "password": obj.get("password")}
        )
        return _obj
