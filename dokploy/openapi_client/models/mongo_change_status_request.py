...
class MongoChangeStatusRequest(BaseModel):
    """MongoChangeStatusRequest
    """  # noqa: E501

    mongo_id: StrictStr = Field(alias="mongoId")
    application_status: StrictStr = Field(alias="applicationStatus")
    __properties: ClassVar[list[str]] = ["mongoId", "applicationStatus"]
    ...
    def from_dict(cls, obj: dict[str, Any] | None) -> Self | None:
        ...
        _obj = cls.model_validate({"mongoId": obj.get("mongoId"), "applicationStatus": obj.get("applicationStatus")})
        return _obj
