...
class PostgresSaveExternalPortRequest(BaseModel):
    """PostgresSaveExternalPortRequest
    """  # noqa: E501

    postgres_id: StrictStr = Field(alias="postgresId")
    external_port: StrictFloat | StrictInt | None = Field(alias="externalPort")
    __properties: ClassVar[list[str]] = ["postgresId", "externalPort"]
    ...
    def from_dict(cls, obj: dict[str, Any] | None) -> Self | None:
        ...
        _obj = cls.model_validate({"postgresId": obj.get("postgresId"), "externalPort": obj.get("externalPort")})
        return _obj
