...
class PostgresSaveEnvironmentRequest(BaseModel):
    ...
    def from_dict(cls, obj: dict[str, Any] | None) -> Self | None:
        ...
        _obj = cls.model_validate({"postgresId": obj.get("postgresId"), "env": obj.get("env")})
        return _obj
