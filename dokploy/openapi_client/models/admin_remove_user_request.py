...
class AdminRemoveUserRequest(BaseModel):
    ...
    auth_id: Annotated[str, Field(min_length=1, strict=True)] = Field(alias="authId")
    __properties: ClassVar[list[str]] = ["authId"]
    ...
    def from_dict(cls, obj: dict[str, Any] | None) -> Self | None:
        ...
        _obj = cls.model_validate({"authId": obj.get("authId")})
        return _obj
