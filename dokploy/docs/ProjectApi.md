...
------------- | ------------- | -------------
[**project_all**](ProjectApi.md#project_all) | **GET** /project.all | 
[**project_create**](ProjectApi.md#project_create) | **POST** /project.create | 
[**project_one**](ProjectApi.md#project_one) | **GET** /project.one | 
[**project_remove**](ProjectApi.md#project_remove) | **POST** /project.remove | 
[**project_update**](ProjectApi.md#project_update) | **POST** /project.update | 
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_instance.project_all()
    except Exception as e:
        print("Exception when calling ProjectApi->project_all: %s\n" % e)
```
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_instance.project_one(project_id)
    except Exception as e:
        print("Exception when calling ProjectApi->project_one: %s\n" % e)
```
...
# **project_remove**
> project_remove(project_remove_request)
...
with openapi_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = openapi_client.ProjectApi(api_client)
    project_remove_request = openapi_client.ProjectRemoveRequest() # ProjectRemoveRequest | 

    try:
        api_instance.project_remove(project_remove_request)
    except Exception as e:
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **project_remove_request** | [**ProjectRemoveRequest**](ProjectRemoveRequest.md)|  | 
...
# **project_update**
> project_update(project_update_request)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_instance.project_update(project_update_request)
    except Exception as e:
