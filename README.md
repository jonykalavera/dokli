...
- `dokli ls [<conn>] [--type TYPE] [--search TERM]` — flat list of every service and its id (project/environment/type/name/appName), handy for scripting and agents; `--type` filters by service type, `--search` by name.
